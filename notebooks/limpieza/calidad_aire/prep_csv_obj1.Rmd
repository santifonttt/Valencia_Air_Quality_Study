...
```{r}
df <- read.csv("~/Documents/Drive/UPV/Segundo/2ºCuatri/Proyecto/Analisis_aire/data/raw/calidad_aire/Base_Datos_filtradas_desde_2019/conjunto_estaciones.csv", stringsAsFactors = FALSE)
```
