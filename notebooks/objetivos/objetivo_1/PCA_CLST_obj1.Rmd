...
```{r}
length(datos_limpios$FechaHora)
```
...
Como habiamos visto, la variable $SO2$ tiene un loading alto en la dimensión 3, por lo que explica bastante la variailidad en esa componente.
...
Observamos que el valor más alto en Quart de Poblet el 3 de Febrero de 2023 a las 8 de la mañana. Esto podría deberse a muchos factores.
