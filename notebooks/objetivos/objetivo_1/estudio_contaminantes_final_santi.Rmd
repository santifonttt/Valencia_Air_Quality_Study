...
df1 <- df1 %>%
  mutate(
    FechaHora = as.POSIXct(paste(Fecha, sprintf("%02d:00:00", Hora)), format = "%Y-%m-%d %H:%M:%S", tz = "UTC")
  )
...
mediciones <- c(
  ...
  "Radiacion_solar", "Precipitacion", "Veloc.máx.",
...
Ahora que ya sabemos l distribución de los datos, es decir en que años y que estaciones se miden, vamos a empezar el analisis de los contaminantes, exclusivamente. Me refiero a que vamos a estudiar las siguientes variables:
