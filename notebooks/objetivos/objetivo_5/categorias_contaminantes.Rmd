...
```{r}
write.csv(df_categorias, file = "~/Documents/Drive/UPV/Segundo/2ºCuatri/Proyecto/Analisis_aire/notebooks/objetivos/objetivo_5/categorias_contaminantes.csv", row.names = FALSE)
```
